...
public interface GhidraOptions {
	...
	final Color DEFAULT_CURSOR_LINE_COLOR = new Color(0x33, 0x33, 0x00);
	...
	final Color DEFAULT_SELECTION_COLOR = new Color(0x50, 0x40, 0x10);

	final String OPTION_HIGHLIGHT_COLOR = "Selection Colors.Highlight Color";
	final Color DEFAULT_HIGHLIGHT_COLOR = new Color(0x3F, 0x3F, 0xB4);
